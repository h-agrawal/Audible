package com.infy.audible.cart.utility;
...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(AudibleExceptionCart.class)
	public ResponseEntity<ErrorInfo> ekartExceptionHandler(AudibleExceptionCart exception) {
		ErrorInfo error = new ErrorInfo();
