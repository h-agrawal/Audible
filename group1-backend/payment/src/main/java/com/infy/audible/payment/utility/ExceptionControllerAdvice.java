package com.infy.audible.payment.utility;
...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(AudibleExceptionPayment.class)
	public ResponseEntity<ErrorInfo> ekartExceptionHandler(AudibleExceptionPayment exception) {
		ErrorInfo error = new ErrorInfo();
