package com.infy.audible.utility;
...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(AudibleExceptionCustomer.class)
	public ResponseEntity<ErrorInfo> ekartExceptionHandler(AudibleExceptionCustomer exception) {
		ErrorInfo error = new ErrorInfo();
